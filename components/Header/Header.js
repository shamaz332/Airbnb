...
const handleSelect =(ranges)=>{
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
      ...
      {/* search bar */}
      <div className="flex items-center md:border-2 py-2 md: shadow-sm rounded-full ">
        <input
      ...
      <div className="flex items-center space-x-4 justify-end text-gray-500">
        ...
        <div className="cursor-pointer flex items-center space-x-2 border-2 rounded-full p-2">
